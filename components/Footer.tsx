    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="container mx-auto px-4 py-12">
        <div className="grid md:grid-cols-4 gap-8">
          {/* About */}
          <div>
            <h3 className="text-white font-semibold mb-4">About RATFI</h3>
            <p className="text-sm leading-relaxed">
              Measuring passport power through diplomatic reciprocity and visa-free access across 200+ countries.
            </p>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center gap-4 text-sm">
          <p>
            © {currentYear} Travel Freedom Index. Open source project.
          </p>
          <div className="flex gap-6">
            ...
            <a
              href="https://github.com/travelfreedomindex/travelfreedomindex-website/blob/main/LICENSE"
              target="_blank"
              rel="noopener noreferrer"
              className="hover:text-white transition-colors"
            >
